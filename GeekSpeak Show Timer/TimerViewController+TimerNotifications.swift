  ...
  func timerUpdatedTime() {
    if let timer = timer {
      ...
      case .PreShow:
        ...
        timerViews?.ring4fg.progress = 0.0
...
//        timerViews?.ring1fg.progress = timer.percentageComplete(.Section1)
        ...
        // timer.percentageComplete(.Section2)
        timerViews?.ring3fg.progress = 0.0
        timerViews?.ring4fg.progress = 0.0
...
//        timerViews?.ring1fg.progress = timer.percentageComplete(.Section1)
//        timerViews?.ring2fg.progress = timer.percentageCompleteUnlimited
        timerViews?.ring3fg.progress = timer.percentageCompleteUnlimited
        // timer.percentageComplete(.Section3)
        timerViews?.ring4fg.progress = 0.0
        segmentLabelText = "Section 2"
...
//        timerViews?.ring1fg.progress = timer.percentageComplete(.Section1)
//        timerViews?.ring2fg.progress = timer.percentageComplete(.Section2)
        timerViews?.ring4fg.progress = timer.percentageComplete // timer.percentageComplete(.Section3)
